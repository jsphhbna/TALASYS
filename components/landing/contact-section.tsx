    ...
    <section className="py-20 bg-white dark:bg-slate-900" id="contact">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div 
            className="flex flex-col items-center p-8 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-700 text-center group transition-transform hover:-translate-y-1"
          ...
          >
            ...
            <h3 className="text-lg font-bold text-[#0C2340] dark:text-blue-50 mb-2">Location</h3>
          ...
          >
            ...
            <h3 className="text-lg font-bold text-[#0C2340] dark:text-blue-50 mb-2">Telephone</h3>
            <p className="text-slate-600 dark:text-slate-400 text-sm font-medium">
              (02) 711 5820
            </p>
          </div>
          ...
          >
            ...
            <h3 className="text-lg font-bold text-[#0C2340] dark:text-blue-50 mb-2">Email</h3>
            <p className="text-slate-600 dark:text-slate-400 text-sm font-medium break-all">
        ...
        <div className="mt-20 pt-10 border-t border-slate-200 dark:border-slate-700 text-center">
