    ...
    <section className="py-20 bg-white" id="mission">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          {/* Mission Card */}
          <div 
            className="flex flex-col p-8 md:p-10 bg-slate-50 border border-slate-200 group transition-all"
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-[#0C2340] mb-4">Mission</h3>
          ...
          {/* Vision Card */}
          <div 
            className="flex flex-col p-8 md:p-10 bg-[#0C2340] border border-[#1a3a5c] group transition-all"
            style={{ borderRadius: "var(--radius-xl)", boxShadow: "var(--shadow-sm)" }}
          >
