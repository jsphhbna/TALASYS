...
const residentNavItems: ResidentMobileNavItem[] = [
  { label: "Home", href: "/resident/dashboard", icon: LayoutDashboard },
  { label: "Profile", href: "/resident/profile", icon: User },
  { label: "Request", href: "/resident/request", icon: FileText },
  { label: "History", href: "/resident/history", icon: Clock },
