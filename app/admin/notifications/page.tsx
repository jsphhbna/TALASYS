...
import { adminNotifications, notificationSummary } from "@/lib/admin-data"
  ...
  return (
    <AdminPageShell>
          ...
          <div className="grid grid-cols-4 gap-4 mb-6">
            ...
            {notificationSummary.slice(0, 3).map((ns, i) => (
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <button className="text-[11px] text-[#0C2340] font-medium hover:underline">Mark all as read</button>
          </div>
          ...
          <Card className="shadow-sm">
            <div className="divide-y divide-slate-100">
              {filteredNotifications.map((notification) => (
                <div
                  key={notification.id}
                  onClick={() => { setSelectedNotification(notification); setShowPreviewDialog(true) }}
