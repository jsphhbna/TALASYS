...
import { categoryPopulationTrend } from "@/lib/admin-data"
import {
...
export default function CategoryReports() {
  ...
  const categories = [
    { id: "senior", name: "Senior Citizens", icon: "👴", count: 423, color: "bg-blue-50", iconBg: "bg-blue-100" },
    { id: "minor", name: "Minors (Under 18)", icon: "👶", count: 612, color: "bg-amber-50", iconBg: "bg-amber-100" },
    { id: "adult", name: "Adults", icon: "👤", count: 1812, color: "bg-green-50", iconBg: "bg-green-100" },
    { id: "voters", name: "Registered Voters", icon: "🗳️", count: 1892, color: "bg-blue-50", iconBg: "bg-blue-100" },
    { id: "non-voters", name: "Non-Voters", icon: "✗", count: 955, color: "bg-red-50", iconBg: "bg-red-100" },
    { id: "expired", name: "Expired Accounts", icon: "⏰", count: 47, color: "bg-red-50", iconBg: "bg-red-100" },
    { id: "all", name: "Full Population", icon: "👥", count: 2847, color: "bg-purple-50", iconBg: "bg-purple-100" },
  ]

  const categoryDistribution = [
    { name: "Senior", value: 423, color: "#2563eb" },
    { name: "Minor", value: 612, color: "#d97706" },
    { name: "Adult", value: 1812, color: "#16a34a" },
  ]
            ...
            <div className="col-span-4 grid grid-cols-1 gap-4">
              <Card className="p-4 shadow-sm flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-[#0C2340]">2,847</p>
                </div>
              </Card>
              <Card className="p-4 shadow-sm flex items-center gap-4">
