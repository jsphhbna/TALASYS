...
import { adminDocumentRequests, requestTypeTrend } from "@/lib/admin-data"
import {
              ...
              <Card className="w-full max-w-md p-0 shadow-2xl">
                ...
                <div className="p-6">
                  ...
                  <div className="flex gap-3">
                    <Button onClick={() => setShowApproveDialog(false)} className="flex-1 h-10 bg-emerald-600 hover:bg-emerald-700">Confirm Approve</Button>
            ...
            <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50">
              <Card className="w-full max-w-md p-0 shadow-2xl">
                ...
                <div className="p-6">
                  ...
                  <div className="flex gap-3">
                    <Button onClick={() => setShowRejectDialog(false)} className="flex-1 h-10 bg-red-600 hover:bg-red-700">Confirm Reject</Button>
