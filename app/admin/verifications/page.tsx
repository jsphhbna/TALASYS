...
import { pendingVerifications, verificationFlowTrend } from "@/lib/admin-data"
import {
              ...
              <div className="divide-y divide-slate-100">
                ...
                {filteredItems.length === 0 && (
                  <div className="p-8 text-center">
                    <p className="text-sm text-slate-400">No pending items</p>
                  </div>
                )}
              </div>
            </Card>
                ...
                <>
                  ...
                  <div className="p-5 space-y-5">
                    ...
                    <div className="flex gap-3 pt-2">
                      <Button className="flex-1 h-10 bg-emerald-600 hover:bg-emerald-700">Approve</Button>
                      <Button className="flex-1 h-10 bg-red-600 hover:bg-red-700">Reject</Button>
                    </div>
                  </div>
                </>
              ) : (
