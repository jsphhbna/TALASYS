  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col">
      ...
      <div className="flex-1 max-w-3xl mx-auto px-4 py-12">
        <h1 className="text-2xl font-bold text-[#0C2340] dark:text-blue-50 mb-4">Frequently Asked Questions</h1>
        <div className="space-y-4">
          {[
            ...
            <div key={i} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg p-5">
              <h3 className="font-semibold text-[#0C2340] dark:text-blue-50 mb-2">{item.q}</h3>
