  ...
  return (
    <div className="flex-1 max-w-4xl mx-auto px-4 py-12 w-full">
      <div className="text-center mb-10">
        <h1 className="text-3xl font-bold text-[#0C2340] dark:text-blue-50 mb-3">Legal & Security</h1>
        <p className="text-slate-600 dark:text-slate-400 text-[15px]">Information regarding our policies and how we protect your data.</p>
      </div>
      ...
      <Tabs defaultValue={defaultTab} className="w-full">
        ...
        <TabsContent value="privacy" className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl p-8" style={{ boxShadow: "var(--shadow-sm)" }}>
          <h2 className="text-2xl font-bold text-[#0C2340] dark:text-blue-50 mb-6">Privacy Policy</h2>
          <div className="prose prose-sm max-w-none text-slate-700 dark:text-slate-300">
            <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">Last updated: January 1, 2025</p>
            
            <h3 className="text-lg font-semibold text-[#0C2340] dark:text-blue-50 mt-6 mb-2">1. Information We Collect</h3>
            ...
            <h3 className="text-lg font-semibold text-[#0C2340] dark:text-blue-50 mt-6 mb-2">2. How We Use Your Information</h3>
            ...
            <h3 className="text-lg font-semibold text-[#0C2340] dark:text-blue-50 mt-6 mb-2">3. Data Protection</h3>
            ...
            <h3 className="text-lg font-semibold text-[#0C2340] dark:text-blue-50 mt-6 mb-2">4. Your Rights</h3>
        ...
        <TabsContent value="terms" className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl p-8" style={{ boxShadow: "var(--shadow-sm)" }}>
          <h2 className="text-2xl font-bold text-[#0C2340] dark:text-blue-50 mb-6">Terms of Service</h2>
          <div className="prose prose-sm max-w-none text-slate-700 dark:text-slate-300">
            <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">Last updated: January 1, 2025</p>
            
            <h3 className="text-lg font-semibold text-[#0C2340] dark:text-blue-50 mt-6 mb-2">1. Acceptance of Terms</h3>
            ...
            <h3 className="text-lg font-semibold text-[#0C2340] dark:text-blue-50 mt-6 mb-2">2. Account Registration</h3>
            ...
            <h3 className="text-lg font-semibold text-[#0C2340] dark:text-blue-50 mt-6 mb-2">3. Use of Services</h3>
            ...
            <h3 className="text-lg font-semibold text-[#0C2340] dark:text-blue-50 mt-6 mb-2">4. Account Validity</h3>
            ...
            <h3 className="text-lg font-semibold text-[#0C2340] dark:text-blue-50 mt-6 mb-2">5. Document Requests</h3>
        ...
        <TabsContent value="security" className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl p-8" style={{ boxShadow: "var(--shadow-sm)" }}>
          <h2 className="text-2xl font-bold text-[#0C2340] dark:text-blue-50 mb-6">Security & Authentication</h2>
          <div className="prose prose-sm max-w-none text-slate-700 dark:text-slate-300">
            ...
            <h3 className="text-lg font-semibold text-[#0C2340] dark:text-blue-50 mt-6 mb-2">1. Firebase Authentication</h3>
            ...
            <h3 className="text-lg font-semibold text-[#0C2340] dark:text-blue-50 mt-6 mb-2">2. Data Encryption</h3>
            ...
            <h3 className="text-lg font-semibold text-[#0C2340] dark:text-blue-50 mt-6 mb-2">3. Secure Document Storage</h3>
